...
public class Api {
     ...
     * @return
     */
    public static UrlParamPair SearchMusicList(String s,String type,int offset) {
        UrlParamPair upp = new UrlParamPair();
        upp.addPara("s", s);
        upp.addPara("type",type);
        upp.addPara("offset", offset*20);
        upp.addPara("total", "True");
        upp.addPara("limit", 20);
        upp.addPara("n", 1000);
        upp.addPara("csrf_token", "33940097960b59735e6b43cbba39e677");
        return upp;
    }
